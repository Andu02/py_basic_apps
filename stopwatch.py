...
def create_window(theme):
    ...
    layout = [
        [sg.Push(), sg.Image('cross.png', pad=(0, 5), enable_events=True, key='-CLOSE-')],
        [sg.VPush()],
    ...
    return sg.Window('Stopwatch', layout, size = (350, 350), no_titlebar = True, element_justification = 'center')
